...
if __name__ == '__main__':
    ...
    parser.add_argument('--event_file', type=str, help='Path to events.h5 file', default="../events.h5")
    parser.add_argument('--output_file', help='Path to write video file', default="../events.mp4")
